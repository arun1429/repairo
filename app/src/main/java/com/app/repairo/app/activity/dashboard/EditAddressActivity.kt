...
class EditAddressActivity : AppCompatActivity() {
    ...
    private var editlandmark : EditText? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        selectedCity = intent.getStringExtra("city").toString()
        selectedPinCode = intent.getStringExtra("pincode").toString()
        selectedDefault = intent.getStringExtra("is_default").toString()
        editAddress!!.setText(intent.getStringExtra("address").toString())
        editlandmark!!.setText(intent.getStringExtra("landmark").toString())
        ...
        button!!.setOnClickListener {
           if (editAddress!!.getText().toString() == "") {
                OkDialog.show(this@EditAddressActivity, "Please enter address")
            }else {
        ...
        spin.setSelection(cityArrayList.indexOf(selectedCity))
        spinPinCode.setSelection(pincodeArrayList.indexOf(selectedPinCode))
    }

    private fun updateProfileApisCall() {
        var userID = RequestBody.create("text/plain".toMediaTypeOrNull(),
            Preferences.getString(this@EditAddressActivity,"id"));
        ...
        val progressBarHandler = ProgressBarHandler(this@EditAddressActivity)
        progressBarHandler.show()
        val apiInterface = ApiClient.getRetrofitClientForAuth(this@EditAddressActivity).create(
            ApiInterface::class.java
        )
        val observable = apiInterface.updateAddress(userID,addressId,address,selectedCity,selectedState,selectedPinCode,selectedDefault,landmark)
